...
const C = {
  ...
  borde:      "#D1D9E6", bordeAct: "#4A90D9",  azul: "#003087",
  azulSuave:  "#EBF1FA", amarillo: "#C07010",  amarilloS: "#FFF8EE",
...
function Badge({ nivel }) {
  ...
  const m = { 3: { l: "Alta confianza", c: C.azul, bg: C.azulSuave }, 2: { l: "Confianza media", c: C.amarillo, bg: C.amarilloS }, 1: { l: "Verificar", c: C.rojo, bg: C.rojoSuave } }[nivel];
  return (
...
function RefCard({ prod }) {
  return (
    <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "4px 10px", background: C.azulSuave, border: `1px solid ${C.azul}30`, borderRadius: "6px", margin: "2px" }}>
      <span style={{ fontSize: "10px", fontWeight: "700", color: C.azul }}>✓</span>
      <div>
            ...
            <div className="sidebar-panel open" style={{ width: "252px", background: C.blanco, borderRight: `1px solid ${C.borde}`, display: "flex", flexDirection: "column", flexShrink: 0 }}>
              ...
              <div style={{ padding: "10px 12px", borderTop: `1px solid ${C.borde}` }}>
                ...
                {(configTurno.instalacion || configTurno.potencia) && (
                  <div style={{ marginTop: "6px", padding: "5px 8px", background: C.azulSuave, border: `1px solid ${C.azul}30`, borderRadius: "4px", fontSize: "10px", color: C.azul, fontWeight: "600" }}>
              ...
              {refsTurno.length > 0 && (
                <div style={{ padding: "10px 12px", borderTop: `1px solid ${C.borde}` }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "4px", maxHeight: "100px", overflowY: "auto" }}>
                    {refsTurno.map((r, i) => (
                      <div key={i} style={{ fontSize: "10px", padding: "3px 7px", background: C.azulSuave, borderRadius: "4px", color: C.texto }}>
                        <span style={{ fontWeight: "700", color: C.azul }}>✓</span> {r.ref} <span style={{ color: C.textoTer }}>· {r.precio}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div style={{ marginTop: "8px", padding: "9px 11px", background: C.fondo, border: `1px solid ${C.borde}`, borderRadius: "5px" }}>
                    {!stats ? <div style={{ fontSize: "11px", color: C.textoTer }}>Sin datos aún.</div> : (
                      <>
                        ...
                        <div style={{ fontSize: "11px", color: C.textoSec, marginBottom: "4px" }}>Alta confianza: <strong style={{ color: C.azul }}>{stats.pA}%</strong></div>
              ...
              {msgs.length === 0 && !streamText && (
                <div style={{ maxWidth: "620px", margin: "0 auto", animation: "fadeIn .3s ease" }}>
                  ...
                  <p style={{ fontSize: "13px", color: C.textoSec, lineHeight: "1.6", marginBottom: "18px", paddingLeft: "58px" }}>
                    ...
                    {(configTurno.instalacion || configTurno.potencia) && (
                      <span style={{ display: "block", marginTop: "4px", fontSize: "11px", color: C.azul }}>
